...
if(mysqli_num_rows($result) > 0){
    ...
    <td width=\"13%\"><font face='Arial'><b>Numero de Cedula</b></font></td>
    <td width=\"14%\"><font face='Arial'><b>Fecha de Nacimiento</b></font></td></tr>";
    if($row = mysqli_fetch_assoc($result)){
      echo "<td width=\"22%\"><font face=\"Arial\">".$row['Nombre']. "</font></td>";
      echo "<td width=\"22%\"><font face=\"Arial\">" .$row['Correo']. "</font></td>";
      echo "<td width=\"13%\"><font face=\"Arial\">" .$row['Numero Cedula']. "</font></td>"; 
      echo "<td width=\"14%\"><font face=\"Arial\">" .$row['Fecha Nacimiento']. "</font></td></tr>";
      echo "</table>";
    }else{
