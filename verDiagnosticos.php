...
$sql = "SELECT * FROM Diagnostico WHERE `Nombre Paciente` LIKE '$nombrePaciente%'";
...
if(mysqli_num_rows($result) > 0){
    ...
    <td><font face='Arial'><b>Nombre de Paciente</b></font></td>
    <td><font face='Arial'><b>Promedio de Aciertos</b></font></td>
    <td><font face='Arial'><b>Fecha Diagnostico</b></font></td>
    </tr>";
    while($row = mysqli_fetch_array($result)){
      echo "<tr><td width=\"25%\"><font face=\"Arial\">". $row["Nombre Paciente"] . "</font></td>";
      echo "<td width=\"25%\"><font face=\"Arial\">" . $row["Promedio Aciertos"] . "</font></td>";
